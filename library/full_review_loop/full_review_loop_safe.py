...
{"5. Pay special attention to whether previous CRITICAL/HIGH issues were properly addressed and if any new issues were introduced." if is_rereview else ""}
...
5. Implement the fixes using appropriate tools (Edit, MultiEdit, Write, Bash). WORK ONLY WITHIN THE CURRENT DIRECTORY.
...
3. Generate a comprehensive PR description in markdown format.
4. Prepare and execute the commands to create the PR using the GitHub CLI (gh).
